...
interface LaboratoryStep1Props {
  formData: LaboratoryFormData;
  errors: Partial<LaboratoryFormData>;
  onInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => void;
}

const LaboratoryStep1: React.FC<LaboratoryStep1Props> = ({ formData, errors, onInputChange }) => {
  return (
    <>
...
export default LaboratoryStep1;